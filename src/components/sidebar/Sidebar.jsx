            ...
            <ul className="mt-3">
              ...
              >
                <NavLink
                  ...
                  to="/news"
                  className={`block text-black hover:text-black truncate transition duration-150 ${
                    pathname.includes("news") && "text-deepBlue"
                  }`}
                >
                  <div className="flex items-center">
                    <svg
                    ...
                    >
                      <path
                        fill={pathname.includes("news") ? "#0177FD" : "#A4B4CB"}
              ...
              <li
                className={`px-3 py-4 rounded-lg mb-0.5 last:mb-0 ${
                  pathname.includes("consultation") && "bg-lightblue"
                }`}
              >
                <NavLink
                  end
                  to="/consultation"
                  className={`block text-black hover:text-black truncate transition duration-150 ${
                    pathname.includes("consultation") && "text-deepBlue"
                  }`}
                >
                  <div className="flex items-center">
                    <svg
              ...
              <li
                className={`px-3 py-6 rounded-lg mb-0.5 last:mb-0 ${
                  pathname.includes("settings") && "bg-lightblue"
                }`}
              >
                <NavLink
                  end
                  to="/settings"
                  className={`block text-black hover:text-black truncate transition duration-150 ${
                    pathname.includes("settings") && "text-deepBlue"
                  }`}
                >
                  <div className="flex items-center">
                    <svg
                    ...
                    >
                      <path
                        d="M14.3026 5.919L12.9205 5.47538L13.5713 4.22196C13.6373 4.09076 13.6593 3.94308 13.6345 3.7993C13.6096 3.65551 13.539 3.52271 13.4324 3.41921L11.8748 1.91933C11.7668 1.81518 11.6275 1.74625 11.4767 1.72225C11.3258 1.69826 11.171 1.72039 11.0339 1.78554L9.73224 2.41225L9.27156 1.08137C9.2229 0.942649 9.13055 0.821978 9.00735 0.736156C8.88415 0.650333 8.73623 0.603629 8.58418 0.602541H6.39043C6.23713 0.60216 6.08758 0.648185 5.96292 0.734109C5.83826 0.820034 5.7448 0.941513 5.69574 1.08137L5.23506 2.41225L3.93343 1.78554C3.79719 1.72201 3.64383 1.70076 3.49452 1.72473C3.3452 1.74869 3.20729 1.81669 3.09981 1.91933L1.54224 3.41921C1.43408 3.52326 1.36251 3.65734 1.33759 3.8026C1.31266 3.94785 1.33565 4.09698 1.40331 4.229L2.05412 5.48242L0.672057 5.92604C0.527995 5.97289 0.402683 6.06183 0.31356 6.18046C0.224437 6.2991 0.175936 6.44154 0.174807 6.58796V8.70046C0.174411 8.84808 0.222206 8.99209 0.311435 9.11213C0.400665 9.23218 0.526816 9.32218 0.672057 9.36942L2.05412 9.81304L1.40331 11.0665C1.33733 11.1977 1.31527 11.3453 1.34015 11.4891C1.36504 11.6329 1.43565 11.7657 1.54224 11.8692L3.09981 13.3691C3.20786 13.4732 3.3471 13.5422 3.49794 13.5662C3.64878 13.5902 3.80364 13.568 3.94074 13.5029L5.24237 12.8762L5.70306 14.207C5.75211 14.3469 5.84558 14.4684 5.97024 14.5543C6.09489 14.6402 6.24444 14.6863 6.39774 14.6859H8.59149C8.7448 14.6863 8.89435 14.6402 9.019 14.5543C9.14366 14.4684 9.23713 14.3469 9.28618 14.207L9.74687 12.8762L11.0485 13.5029C11.1839 13.5648 11.3357 13.5852 11.4835 13.5613C11.6313 13.5373 11.7679 13.4702 11.8748 13.3691L13.4324 11.8692C13.5405 11.7652 13.6121 11.6311 13.637 11.4858C13.662 11.3406 13.639 11.1914 13.5713 11.0594L12.9205 9.806L14.3026 9.36237C14.4466 9.31552 14.5719 9.22659 14.6611 9.10795C14.7502 8.98932 14.7987 8.84688 14.7998 8.70046V6.58796C14.8002 6.44033 14.7524 6.29632 14.6632 6.17628C14.574 6.05624 14.4478 5.96624 14.3026 5.919ZM13.3373 8.19346L12.4598 8.47513C12.258 8.53815 12.0729 8.6427 11.9173 8.78151C11.7616 8.92032 11.6392 9.09007 11.5585 9.27899C11.4778 9.46791 11.4408 9.67147 11.4499 9.87555C11.4591 10.0796 11.5142 10.2794 11.6116 10.4609L12.0284 11.2636L11.224 12.0382L10.4123 11.6157C10.2248 11.5257 10.0194 11.4756 9.80999 11.4687C9.6006 11.4619 9.39212 11.4984 9.19866 11.5758C9.00521 11.6533 8.8313 11.7699 8.68869 11.9177C8.54609 12.0655 8.43813 12.2411 8.37212 12.4325L8.07962 13.2775H6.91693L6.62443 12.4325C6.55898 12.2382 6.45041 12.06 6.30626 11.9101C6.16212 11.7602 5.98584 11.6423 5.78965 11.5646C5.59347 11.4869 5.38208 11.4512 5.17014 11.4601C4.9582 11.4689 4.7508 11.522 4.56231 11.6157L3.72868 12.0171L2.92431 11.2425L3.36306 10.4609C3.46038 10.2794 3.51554 10.0796 3.5247 9.87555C3.53386 9.67147 3.4968 9.46791 3.4161 9.27899C3.3354 9.09007 3.21299 8.92032 3.05735 8.78151C2.90172 8.6427 2.71659 8.53815 2.51481 8.47513L1.63731 8.19346V7.09496L2.51481 6.81329C2.71659 6.75026 2.90172 6.64572 3.05735 6.50691C3.21299 6.3681 3.3354 6.19835 3.4161 6.00943C3.4968 5.82051 3.53386 5.61695 3.5247 5.41286C3.51554 5.20878 3.46038 5.00905 3.36306 4.82754L2.94624 4.04592L3.75062 3.27133L4.56231 3.67271C4.7508 3.76643 4.9582 3.81954 5.17014 3.82836C5.38208 3.83718 5.59347 3.8015 5.78965 3.72379C5.98584 3.64608 6.16212 3.5282 6.30626 3.37833C6.45041 3.22846 6.55898 3.05018 6.62443 2.85587L6.91693 2.01087H8.05768L8.35018 2.85587C8.41564 3.05018 8.5242 3.22846 8.66835 3.37833C8.8125 3.5282 8.98878 3.64608 9.18496 3.72379C9.38115 3.8015 9.59254 3.83718 9.80447 3.82836C10.0164 3.81954 10.2238 3.76643 10.4123 3.67271L11.2459 3.27133L12.0503 4.04592L11.6116 4.82754C11.5181 5.00812 11.4661 5.20592 11.4589 5.40756C11.4518 5.60919 11.4897 5.80995 11.5702 5.99623C11.6506 6.18252 11.7717 6.35 11.9251 6.48732C12.0786 6.62464 12.261 6.7286 12.4598 6.79217L13.3373 7.07383V8.19346ZM7.48731 4.82754C6.9088 4.82754 6.34328 4.99274 5.86227 5.30224C5.38125 5.61174 5.00635 6.05164 4.78496 6.56632C4.56357 7.08099 4.50565 7.64733 4.61851 8.19371C4.73137 8.74009 5.00995 9.24197 5.41902 9.63589C5.82809 10.0298 6.34927 10.2981 6.91667 10.4068C7.48406 10.5154 8.07218 10.4597 8.60666 10.2465C9.14113 10.0333 9.59795 9.67226 9.91936 9.20906C10.2408 8.74587 10.4123 8.20129 10.4123 7.64421C10.4123 6.89718 10.1041 6.18075 9.55559 5.65252C9.00705 5.1243 8.26307 4.82754 7.48731 4.82754ZM7.48731 9.05254C7.19805 9.05254 6.91529 8.96994 6.67479 8.81519C6.43428 8.66045 6.24683 8.44049 6.13613 8.18315C6.02544 7.92581 5.99648 7.64265 6.05291 7.36946C6.10934 7.09627 6.24863 6.84533 6.45316 6.64837C6.6577 6.45141 6.91829 6.31728 7.20199 6.26294C7.48568 6.20859 7.77974 6.23648 8.04698 6.34308C8.31422 6.44967 8.54263 6.63018 8.70333 6.86178C8.86403 7.09338 8.94981 7.36567 8.94981 7.64421C8.94981 8.01772 8.79572 8.37594 8.52145 8.64005C8.24718 8.90416 7.87519 9.05254 7.48731 9.05254Z"
                        fill={
                          pathname.includes("settings") ? "#0177FD" : "#A4B4CB"
                        }
                      />
                    </svg>

            ...
            <ul className="mt-3">
              ...
              >
                <NavLink
                  ...
                  to="/dating"
                  className={`block text-black hover:text-black truncate transition duration-150 ${
                    pathname.includes("dating") && "text-deepBlue"
                  }`}
                >
                  <div className="flex items-center">
                    <svg
                    ...
                    >
                      <path
                        fill={
                          pathname.includes("dating") ? "#0177FD" : "#A4B4CB"
                        }
                        d="M9.4751 5.2873C9.28116 5.2873 9.09516 5.36435 8.95803 5.50148C8.82089 5.63862 8.74385 5.82462 8.74385 6.01855V13.3311C8.74385 13.525 8.82089 13.711 8.95803 13.8481C9.09516 13.9853 9.28116 14.0623 9.4751 14.0623C9.66904 14.0623 9.85503 13.9853 9.99217 13.8481C10.1293 13.711 10.2063 13.525 10.2063 13.3311V6.01855C10.2063 5.82462 10.1293 5.63862 9.99217 5.50148C9.85503 5.36435 9.66904 5.2873 9.4751 5.2873ZM5.81885 9.6748C5.62491 9.6748 5.43891 9.75185 5.30178 9.88898C5.16464 10.0261 5.0876 10.2121 5.0876 10.4061V13.3311C5.0876 13.525 5.16464 13.711 5.30178 13.8481C5.43891 13.9853 5.62491 14.0623 5.81885 14.0623C6.01279 14.0623 6.19878 13.9853 6.33592 13.8481C6.47306 13.711 6.5501 13.525 6.5501 13.3311V10.4061C6.5501 10.2121 6.47306 10.0261 6.33592 9.88898C6.19878 9.75185 6.01279 9.6748 5.81885 9.6748ZM13.1313 8.2123C12.9374 8.2123 12.7514 8.28935 12.6143 8.42648C12.4771 8.56362 12.4001 8.74962 12.4001 8.94355V13.3311C12.4001 13.525 12.4771 13.711 12.6143 13.8481C12.7514 13.9853 12.9374 14.0623 13.1313 14.0623C13.3253 14.0623 13.5113 13.9853 13.6484 13.8481C13.7856 13.711 13.8626 13.525 13.8626 13.3311V8.94355C13.8626 8.74962 13.7856 8.56362 13.6484 8.42648C13.5113 8.28935 13.3253 8.2123 13.1313 8.2123ZM14.5938 2.3623H4.35635C3.77453 2.3623 3.21654 2.59343 2.80513 3.00484C2.39372 3.41625 2.1626 3.97424 2.1626 4.55605V14.7936C2.1626 15.3754 2.39372 15.9334 2.80513 16.3448C3.21654 16.7562 3.77453 16.9873 4.35635 16.9873H14.5938C15.1757 16.9873 15.7337 16.7562 16.1451 16.3448C16.5565 15.9334 16.7876 15.3754 16.7876 14.7936V4.55605C16.7876 3.97424 16.5565 3.41625 16.1451 3.00484C15.7337 2.59343 15.1757 2.3623 14.5938 2.3623ZM15.3251 14.7936C15.3251 14.9875 15.2481 15.1735 15.1109 15.3106C14.9738 15.4478 14.7878 15.5248 14.5938 15.5248H4.35635C4.16241 15.5248 3.97641 15.4478 3.83928 15.3106C3.70214 15.1735 3.6251 14.9875 3.6251 14.7936V4.55605C3.6251 4.36212 3.70214 4.17612 3.83928 4.03898C3.97641 3.90185 4.16241 3.8248 4.35635 3.8248H14.5938C14.7878 3.8248 14.9738 3.90185 15.1109 4.03898C15.2481 4.17612 15.3251 4.36212 15.3251 4.55605V14.7936Z"
                      />
                    </svg>
